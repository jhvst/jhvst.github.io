...
#let acmart(
  ...
  authors: (
    (
      ...
      email: "juuso.haavisto@cs.ox.ac.uk"
    ),
  ),
  ...
  ccs-concepts: (
    (
      ...
      specific: ("Parallel computing methodologies", ),
    ),
  ),
  ...
  conference: (
    name: "ACM SIGPLAN International Workshop on Libraries, Languages and Compilers for Array Programming",
    short: "ARRAY 2024",
    year: "2024",
    date: "Jun 25",
